...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for gpd in livingGhostPositionDistributions:
            ...
            for currPos, currProb in gpd.items():
        ...
        for currPos  in gPos:
            currDist   = self.distancer.getDistance(pacmanPosition, currPos)
        ...
        for a in legal:
            aDist = self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, a), cGhost)
